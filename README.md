...
2. Push your source files to the repository.
3. Navigate to the repository settings.
4. Scroll down to the "GitHub Pages" section.
5. Choose the source branch (e.g., `main`) and save.
6. Your site will be published at `https://<username>.github.io/<repository>`.

For more details, visit the [GitHub Pages documentation](https://docs.github.com/en/pages).